            ...
            <div id="map">
				<div id="area">
					<img src="ship_3.jpg" >
						...
						var id = [["3_조타실", "width: 265px; height: 240px; left : 210px; top : 0px;", 10], // uibt
							["3_승무원휴게실", "width: 265px; height: 105px; left : 210px; top: 243px;", 5], // jang
							["3_승무원실", "width: 265px; height: 226px; left : 210px; top: 350px;", 3], // lab
							["3_복도", "width: 106px; height: 425px; left : 103px; top: 151px;", 1], // hall
							["3_홀", "width: 209px; height: 150px;left : 0px; top: 0px;", 9], // evevator_hall
							["3_계단", "width: 102px; height: 92px; left : 0px; top: 151px;", 8], // stairs
							["3_보일러실", "width: 102px; height: 175px; left : 0px; top: 245px;", 2],
							["3_엔진실", "width: 102px; height: 156px; left : 0px; top: 420px;", 101]]; // toilet

						for(var i =0;i<section1.length;i++) {
							for(var j=0;j<id.length;j++){
								if(section1[i]==id[j][0] && section1[i].substr(0,1)== "3" && ship == "1") {
						...
						var str = "<br><div><a id=\"left\" href=\"http://202.31.147.236/webstandard/캡스톤/img/1/SeeShip2.php?ship_id="+ ship +"\" style=\"text-decoration: none; color: black\">이전</a></div>";
						document.write(str);
						</script>
					</div>
           	 </div>
