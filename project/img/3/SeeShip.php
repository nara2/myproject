        ...
        <div id="container">
            ...
            <div id="map">
				<div id="area">
					...
					var id = [["1_침실", "width: 400px; height: 200px; left : 0px; top : 0px;",201], // uibt
						["1_관물대", "width: 300px; height: 200px; left : 400px; top: 0px;", 202],
						["1_화장실", "width: 180px; height: 100px; left : 700px; top: 0px;", 203],
						["1_샤워실", "width: 180px; height: 100px; left : 880px; top: 0px;", 204],
						["1_복도", "width: 360px; height: 100px; left : 700px; top: 100px;", 205],
						["1_복도", "width: 105px; height: 100px; left : 955px; top: 200px;", 205],
						["1_계단", "width: 180px; height: 100px; left : 775px; top: 200px;", 206],
						["1_식당", "width: 300px; height: 300px; left : 955px; top: 300px;", 207],
						["1_식당", "width: 200px; height: 100px; left : 1057px; top: 200px;", 207]];

					// console.log(section1);
					for(var i =0;i<section1.length;i++) {
						for(var j=0;j<id.length;j++){
							if(section1[i]==id[j][0] && section1[i].substr(0,1)== "1" && ship == "3") {
